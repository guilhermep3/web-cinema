...
export const ReadMoreBanner = ({ movie }: props) => {
  ...
  return (
    <div className="flex relative md:w-10/12 mx-auto p-2 mt-4 min-h-40 md:min-h-96">
      {movie
        ?
      ...
      <div className="absolute bottom-0 p-2 bg-zinc-950 rounded-lg md:rounded-2xl">
        ...
        <div className="absolute h-5 w-5 bottom-0 right-0 rounded-bl-full shadow-[-10px_10px_0px_10px_#09090b] translate-x-[20px] md:translate-x-[24px] -translate-y-[33%] md:h-6 md:w-6"></div>
